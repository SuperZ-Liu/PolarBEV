...
# _C.LIFT.Z_BOUND = [-5.0, 3.0, 8.0]  # Height
# _C.LIFT.Z_BOUND = [-5.0, 5.0, 10.0]  # Height
...
_C.SCHEDULER = CN()
_C.SCHEDULER.DIV_FACTOR = 10
_C.SCHEDULER.PCT_START = 0.3
_C.SCHEDULER.FINAL_DIV_FACTOR = 10
_C.SCHEDULER.MAX_LR = 4e-3
_C.SCHEDULER.TOTAL_STEPS = 30001
_C.SCHEDULER.CYCLE_MOMENTUM = False
_C.GRAD_NORM_CLIP = 5
_C.checkpoint_interval = 1000
