...
from torchmetrics import Metric as Metric_
# from torchmetrics.metric import Metric
from pytorch_lightning.metrics.functional.classification import stat_scores_multiple_classes
# from torchmetrics.functional.classification import stat_scores_multiple_classes
from pytorch_lightning.metrics.functional.reduction import reduce
# from torchmetrics.functional.stat_scores.params.reduce import reduce


class BaseIoUMetric(Metric_):
    """
...
class IntersectionOverUnion_sigmoid(Metric):
