...
from polarbev.layers.convolutions import UpsamplingConcat
...
class Encoder(nn.Module):
    def __init__(self, cfg):
        ...
        self.reduction = nn.Conv2d(upsampling_out_channels, self.C, kernel_size=1, padding=0)
    ...
    def forward(self, x):
        ...
        x = self.reduction(x)  # feature and depth head
